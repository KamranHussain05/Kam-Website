...
const researchItems = [
  {
    ...
    description: 'Autoregressive foundation models for cortical organoid electrophysiology using HD-MEA data.',
  },
  {
    icon: Cpu,
    title: 'Generative Interfaces',
    description: 'Real-time generative interfaces and multimodal speech systems where models drive the UI.',
  },
  {
    icon: Code,
    title: 'Conversational Rate Speech BCI',
    description: 'Speech BCIs that decode intracortical activity at conversational rates.',
  },
  {
    icon: Microscope,
    title: 'AI Wet Lab Assistant',
    description: 'Lab robotics and ML QC to shrink neural and drug-screen assay timelines.',
  },
]
